...
Description: This is an addon for the WooCommerce Booking & Appointment Plugin which lets you to select multiple time slots on a date for each product on the website.
Version: 1.4
...
$MultipleTimeslotUpdateChecker = '1.4';
